...
inline val MediaMetadataCompat.imagePath: String?
...
inline var MediaMetadataCompat.Builder.imagePath: String?
    @Deprecated(NO_GET, level = DeprecationLevel.ERROR)
    get() = throw IllegalAccessException("Cannot get from MediaMetadataCompat.Builder")
    set(value) {
        putString(MediaMetadataCompat.METADATA_KEY_MEDIA_URI, value)
 ...
 */
const val METADATA_KEY_FLAGS = "com.nanicky.devteam.playback.METADATA_KEY_FLAGS"
const val METADATA_KEY_ALBUM_ID = "com.nanicky.devteam.playback.METADATA_KEY_ALBUM_ID"